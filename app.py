                               ...
                               children=[
                                   ...
                                   html.Div(
                                       ...
                                       children=[dcc.Graph(id="timeseries",
                                                           ...
                                                           animate=True,
                                                           #    figure=px.line(
                                                           #        df, x="Date", y="value", color="stock", template="plotly_dark").update_layout(
...
def update_change(selected_dropdown_value):
    ...
    figure = {'data': data,
              'layout': go.Layout(
                  ...
                  hovermode='x',
                  autosize=True,
                  title={'text': 'Daily Change', 'font': {
                      'color': 'white'}, 'x': 0.5},
                  xaxis={'showticklabels': False, 'range': [
                      df_sub.index.min(), df_sub.index.max()]},
              ),
              }
